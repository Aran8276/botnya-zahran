...
export function ChartAreaInteractive({ data }: { data: ChartData[] }) {
  ...
  return (
    <Card className="@container/card">
      <CardHeader>
        <CardTitle>Commands Created</CardTitle>
        <CardDescription>
          <span className="hidden @[540px]/card:block">
            Total commands created over time
          </span>
          <span className="@[540px]/card:hidden">Commands over time</span>
        </CardDescription>
        <CardAction>
          <ToggleGroup
            type="single"
